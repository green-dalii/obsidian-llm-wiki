...
**作者:** Greener-Dalii | **版本:** 1.7.17

[English](README.md) | [中文文档](README_CN.md) | [日本語](README_JA.md) | [한국어](README_KO.md) | [Deutsch](README_DE.md) | [Français](docs/README_FR.md) | [Español](docs/README_ES.md) | [Português](docs/README_PT.md) | [官网](https://llmwiki.greenerai.top/) | [Discussions](https://github.com/green-dalii/obsidian-llm-wiki/discussions)
...
> **从旧版本升级？** 执行 `Cmd+P` → "Regenerate index" 重建带别名的 Wiki 索引——这将启用 Query 中的别名感知搜索（如搜索"DSA"可以找到"DeepSeek-Sparse-Attention"）。
