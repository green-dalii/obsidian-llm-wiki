export const JA_TEXTS = {
    ...
    pdfReadingInProgress: 'PDF を読み込んでいます: {filename}',
    pdfExtractedTextHeading: '抽出したテキスト',
    sourceRejectedPdfUnsupported: '{filename} をスキップしました。設定されたプロバイダーまたはモデルは PDF 入力をサポートしていません。',
