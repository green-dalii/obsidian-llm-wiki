export const JA_TEXTS = {
    ...
    pdfConversionBackendName: 'PDF 変換バックエンド',
    pdfConversionBackendDesc: 'プロバイダー変換またはオンライン MinerU API を選択します。',
    pdfConversionBackendNative: 'プロバイダーの PDF 対応',
    pdfConversionBackendMineru: 'MinerU オンライン API',
    mineruApiTokenName: 'MinerU API トークン',
    mineruApiTokenDesc: 'このバックエンドを選択した場合のみ公式 MinerU API に送信します。',
