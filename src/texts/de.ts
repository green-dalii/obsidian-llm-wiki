export const DE_TEXTS = {
    ...
    pdfExtractedTextHeading: 'Extrahierter Text',
    sourceRejectedPdfUnsupported: '{filename} wurde übersprungen: Der konfigurierte Anbieter oder das Modell unterstützt keine PDF-Eingaben.',
