export const DE_TEXTS = {
    ...
    pdfConversionBackendName: 'PDF-Konvertierungs-Backend',
    pdfConversionBackendDesc: 'Wählen Sie die Provider-Konvertierung oder die Online-MinerU-API.',
    pdfConversionBackendNative: 'Provider-PDF-Unterstützung',
    pdfConversionBackendMineru: 'MinerU-Online-API',
    mineruApiTokenName: 'MinerU-API-Token',
    mineruApiTokenDesc: 'Wird nur bei Auswahl dieses Backends an die offizielle MinerU-API gesendet.',
