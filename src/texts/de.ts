export const DE_TEXTS = {
    ...
    pdfBackendPreparing: 'PDF-Konvertierung wird vorbereitet…',
    mineruRequestingUpload: 'MinerU-Upload wird vorbereitet…',
    mineruUploading: 'PDF wird zu MinerU hochgeladen…',
    mineruWaiting: 'Warten auf MinerU…',
    mineruParsing: 'MinerU analysiert das PDF…',
    mineruParsingPages: 'MinerU analysiert Seite {completed} von {total}…',
    mineruConverting: 'MinerU-Ergebnis wird konvertiert…',
    mineruDownloading: 'MinerU-Ergebnis wird heruntergeladen…',
    mineruValidating: 'MinerU-Ergebnis wird geprüft…',
    mineruSaving: 'Konvertiertes Markdown und Bilder werden gespeichert…',
    mineruMissingToken: '„{filename}": Fügen Sie Ihren MinerU API Token in den Einstellungen hinzu und versuchen Sie es erneut.',
    mineruDesktopOnly: '„{filename}": Die MinerU-PDF-Konvertierung ist nur in der Desktop-App verfügbar.',
    mineruAuthenticationFailed: '„{filename}": MinerU konnte sich nicht authentifizieren. Prüfen Sie Ihren API Token und versuchen Sie es erneut.',
    mineruQuotaExceeded: '„{filename}": Ihr MinerU-Kontingent ist nicht verfügbar oder aufgebraucht. Prüfen Sie Ihr MinerU-Konto und versuchen Sie es erneut.',
    mineruRateLimited: '„{filename}": Die MinerU-Anfrage für dieses PDF ist vorübergehend ratenbegrenzt. Versuchen Sie es später erneut.',
    mineruUploadFailed: '„{filename}": MinerU konnte den PDF-Upload nicht annehmen. Prüfen Sie die Datei und Ihre Verbindung und versuchen Sie es erneut.',
    mineruTaskFailed: '„{filename}": MinerU konnte dieses PDF nicht verarbeiten. Prüfen Sie das PDF und versuchen Sie es erneut.',
    mineruTaskTimedOut: '„{filename}": MinerU wurde nicht vor Ablauf des konfigurierten Zeitlimits fertig. Erhöhen Sie das Zeitlimit oder versuchen Sie es später erneut.',
    mineruDownloadFailed: '„{filename}": Das MinerU-Ergebnis konnte nicht heruntergeladen werden. Prüfen Sie Ihre Verbindung und versuchen Sie es erneut.',
    mineruInvalidResult: '„{filename}": MinerU hat ein Ergebnis zurückgegeben, das nicht sicher verwendet werden konnte. Versuchen Sie das PDF erneut.',
    mineruArtifactConflict: '„{filename}": Der MinerU-Ausgabeordner enthält Dateien, die nicht von diesem Plugin erstellt wurden. Verschieben oder benennen Sie den Ordner um und versuchen Sie es erneut.',
    mineruArtifactWriteFailed: '„{filename}": Das MinerU-Ergebnis konnte nicht in Ihrem Vault gespeichert werden. Prüfen Sie Dateiberechtigungen und freien Speicherplatz und versuchen Sie es erneut.',
    mineruCancelled: '„{filename}": Die MinerU-PDF-Konvertierung wurde abgebrochen.',
    ...
    sourceRejectedManagedArtifact: '„{filename}" befindet sich in einem verwalteten MinerU-Ausgabeordner und kann nicht direkt eingelesen werden. Wählen Sie stattdessen das ursprüngliche PDF aus.',
    clearPdfCacheCommand: 'PDF-Konvertierungs-Cache leeren',
    pdfCacheCleared: 'PDF-Cache geleert ({count} Einträge entfernt).',
    pdfConversionSection: 'PDF-Konvertierung',
    pdfConversionBackendName: 'Konvertierungs-Backend',
    pdfConversionBackendDesc: 'Wählen Sie, wie PDF-Dateien in Markdown konvertiert werden.',
    pdfConversionBackendNative: 'Natives Modell',
    pdfConversionBackendMineru: 'Offizielle MinerU-API',
    mineruApiTokenName: 'MinerU API-Token',
    mineruApiTokenDesc: 'Wird in den Plugin-Einstellungen gespeichert und nur für MinerU-Anfragen verwendet.',
    mineruApiTokenPlaceholder: 'MinerU API-Token einfügen',
    mineruTaskTimeoutName: 'Zeitlimit für Aufgaben (Minuten)',
    mineruTaskTimeoutDesc: 'Beendet das Warten auf eine MinerU-Aufgabe nach 5 bis 120 Minuten.',
    mineruUploadDisclosure: 'Für die MinerU-Konvertierung wird das PDF zum offiziellen MinerU-Dienst hochgeladen. Das konvertierte Markdown und die Bilder werden anschließend in Ihrem Vault gespeichert.',
    mineruDesktopOnlySettingDesc: 'Die MinerU-Konvertierung ist nur in Obsidian Desktop verfügbar.',
