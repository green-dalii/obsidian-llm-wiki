export const ZH_TEXTS = {
    ...
    pdfConversionBackendName: 'PDF 转换后端',
    pdfConversionBackendDesc: '选择现有 provider PDF 转换或在线 MinerU API。',
    pdfConversionBackendNative: 'Provider PDF 支持',
    pdfConversionBackendMineru: 'MinerU 在线 API',
    mineruApiTokenName: 'MinerU API Token',
    mineruApiTokenDesc: '仅在选择该后端时发送到 MinerU 官方 API。',
