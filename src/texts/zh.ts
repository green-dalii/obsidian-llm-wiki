export const ZH_TEXTS = {
    ...
    pdfBackendPreparing: '正在准备 PDF 转换…',
    mineruRequestingUpload: '正在准备上传到 MinerU…',
    mineruUploading: '正在将 PDF 上传到 MinerU…',
    mineruWaiting: '正在等待 MinerU…',
    mineruParsing: 'MinerU 正在解析 PDF…',
    mineruParsingPages: 'MinerU 正在解析第 {completed}/{total} 页…',
    mineruConverting: '正在转换 MinerU 结果…',
    mineruDownloading: '正在下载 MinerU 结果…',
    mineruValidating: '正在检查 MinerU 结果…',
    mineruSaving: '正在保存转换后的 Markdown 和图片…',
    mineruMissingToken: '「{filename}」：请在设置中添加 MinerU API Token，然后重试。',
    ...
    mineruDownloadFailed: '「{filename}」：无法下载 MinerU 结果。请检查网络连接，然后重试。',
    mineruInvalidResult: '「{filename}」：MinerU 返回的结果无法安全使用。请重新转换此 PDF。',
    mineruArtifactConflict: '「{filename}」：MinerU 输出文件夹中包含并非由本插件创建的文件。请移动或重命名该文件夹，然后重试。',
    ...
    pdfConversionBackendName: '转换后端',
    pdfConversionBackendDesc: '选择将 PDF 文件转换为 Markdown 的方式。',
    pdfConversionBackendNative: '原生模型',
    pdfConversionBackendMineru: 'MinerU 官方 API',
    mineruApiTokenName: 'MinerU API Token',
    mineruApiTokenDesc: '保存在本插件的设置中，仅用于向 MinerU 发起请求。',
    mineruApiTokenPlaceholder: '粘贴 MinerU API Token',
    mineruTaskTimeoutName: '任务超时（分钟）',
    mineruTaskTimeoutDesc: '等待 MinerU 任务 5 至 120 分钟后停止。',
    mineruUploadDisclosure: '使用 MinerU 转换时，PDF 会上传至 MinerU 官方服务；转换后的 Markdown 和图片随后保存到你的 Vault。',
    mineruDesktopOnlySettingDesc: 'MinerU 转换仅可在 Obsidian 桌面版中使用。',
