export const IT_TEXTS = {
    ...
    pdfReadingInProgress: 'Lettura del PDF: {filename}',
    pdfExtractedTextHeading: 'Testo estratto',
    sourceRejectedPdfUnsupported: '{filename} ignorato: il provider o modello configurato non supporta l’input PDF.',
