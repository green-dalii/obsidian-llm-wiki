export const IT_TEXTS = {
    ...
    historyButton: '📜 Cronologia acquisizioni',
    historyModalTitle: 'Cronologia acquisizioni',
    historyModalSubtitle: 'Operazioni recenti da {path}',
