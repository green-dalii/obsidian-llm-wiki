export const IT_TEXTS = {
    ...
    pdfConversionBackendName: 'Backend di conversione PDF',
    pdfConversionBackendDesc: 'Scegli la conversione del provider o l’API online MinerU.',
    pdfConversionBackendNative: 'Supporto PDF del provider',
    pdfConversionBackendMineru: 'API online MinerU',
    mineruApiTokenName: 'Token API MinerU',
    mineruApiTokenDesc: 'Viene inviato solo all’API ufficiale MinerU con questo backend.',
