export const IT_TEXTS = {
    ...
    pdfBackendPreparing: 'Preparazione della conversione PDF…',
    mineruRequestingUpload: 'Preparazione del caricamento su MinerU…',
    mineruUploading: 'Caricamento del PDF su MinerU…',
    mineruWaiting: 'In attesa di MinerU…',
    mineruParsing: 'MinerU sta analizzando il PDF…',
    mineruParsingPages: 'MinerU sta analizzando la pagina {completed} di {total}…',
    mineruConverting: 'Conversione del risultato MinerU…',
    mineruDownloading: 'Download del risultato MinerU…',
    mineruValidating: 'Verifica del risultato MinerU…',
    mineruSaving: 'Salvataggio del Markdown convertito e delle immagini…',
    mineruMissingToken: '«{filename}»: Aggiungi il tuo Token API MinerU nelle impostazioni e riprova.',
    ...
    mineruDownloadFailed: '«{filename}»: Non è stato possibile scaricare il risultato MinerU. Controlla la connessione e riprova.',
    mineruInvalidResult: '«{filename}»: MinerU ha restituito un risultato che non poteva essere usato in sicurezza. Riprova il PDF.',
    mineruArtifactConflict: '«{filename}»: La cartella di output MinerU contiene file non creati da questo plugin. Sposta o rinomina la cartella e riprova.',
    mineruArtifactWriteFailed: '«{filename}»: Non è stato possibile salvare il risultato MinerU nel Vault. Controlla i permessi e lo spazio libero e riprova.',
    mineruCancelled: '«{filename}»: La conversione PDF con MinerU è stata annullata.',
    ...
    sourceRejectedManagedArtifact: '«{filename}» si trova in una cartella di output gestita da MinerU e non può essere acquisito direttamente. Seleziona invece il PDF originale.',
    clearPdfCacheCommand: 'Svuota cache di conversione PDF',
    pdfCacheCleared: 'Cache PDF svuotata ({count} voci rimosse).',
    pdfConversionSection: 'Conversione PDF',
    pdfConversionBackendName: 'Backend di conversione',
    pdfConversionBackendDesc: 'Scegli come convertire i file PDF in Markdown.',
    pdfConversionBackendNative: 'Modello nativo',
    pdfConversionBackendMineru: 'API ufficiale MinerU',
    mineruApiTokenName: 'Token API MinerU',
    mineruApiTokenDesc: 'Salvato nelle impostazioni del plugin e usato solo per le richieste MinerU.',
    mineruApiTokenPlaceholder: 'Incolla il tuo Token API MinerU',
    mineruTaskTimeoutName: 'Timeout attività (minuti)',
    mineruTaskTimeoutDesc: 'Interrompe l’attesa di un’attività MinerU dopo 5-120 minuti.',
    mineruUploadDisclosure: 'La conversione MinerU carica il PDF sul servizio ufficiale MinerU. Il Markdown e le immagini convertiti vengono poi salvati nel Vault.',
    mineruDesktopOnlySettingDesc: 'La conversione MinerU è disponibile solo in Obsidian desktop.',
