export const EN_TEXTS = {
    ...
    pdfBackendPreparing: 'Preparing PDF conversion…',
    mineruRequestingUpload: 'Preparing the MinerU upload…',
    mineruUploading: 'Uploading PDF to MinerU…',
    mineruWaiting: 'Waiting for MinerU…',
    mineruParsing: 'MinerU is parsing the PDF…',
    mineruParsingPages: 'MinerU is parsing page {completed} of {total}…',
    mineruConverting: 'Converting the MinerU result…',
    mineruDownloading: 'Downloading the MinerU result…',
    mineruValidating: 'Checking the MinerU result…',
    mineruSaving: 'Saving converted Markdown and images…',
    mineruMissingToken: '"{filename}": Add your MinerU API Token in Settings, then try again.',
    mineruDesktopOnly: '"{filename}": MinerU PDF conversion is available only in the desktop app.',
    mineruAuthenticationFailed: '"{filename}": MinerU could not authenticate. Check your API Token, then try again.',
    mineruQuotaExceeded: '"{filename}": Your MinerU quota is unavailable or exhausted. Check your MinerU account, then try again.',
    mineruUploadFailed: '"{filename}": MinerU could not accept the PDF upload. Check the file and your connection, then try again.',
    mineruTaskFailed: '"{filename}": MinerU could not process this PDF. Check the PDF and try again.',
    mineruTaskTimedOut: '"{filename}": MinerU did not finish before the configured timeout. Increase the timeout or try again later.',
    mineruDownloadFailed: '"{filename}": The MinerU result could not be downloaded. Check your connection, then try again.',
    mineruInvalidResult: '"{filename}": MinerU returned a result that could not be safely used. Try the PDF again.',
    mineruArtifactConflict: '"{filename}": The MinerU output folder contains files not created by this plugin. Move or rename that folder, then try again.',
    mineruArtifactWriteFailed: '"{filename}": The MinerU result could not be saved to your Vault. Check file permissions and free space, then try again.',
    mineruCancelled: '"{filename}": MinerU PDF conversion was cancelled.',
