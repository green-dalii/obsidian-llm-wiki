export const EN_TEXTS = {
    ...
    mineruRateLimited: '"{filename}": The MinerU request for this PDF is temporarily rate limited. Try again later.',
    ...
    sourceRejectedManagedArtifact: '"{filename}" is inside a managed MinerU output folder and cannot be ingested directly. Select the original PDF instead.',
    clearPdfCacheCommand: 'Clear PDF conversion cache',
    pdfCacheCleared: 'PDF cache cleared ({count} entries removed).',
    pdfConversionSection: 'PDF Conversion',
    pdfConversionBackendName: 'Conversion backend',
    pdfConversionBackendDesc: 'Choose how PDF files are converted to Markdown.',
    pdfConversionBackendNative: 'Native model',
    pdfConversionBackendMineru: 'MinerU Official API',
    mineruApiTokenName: 'MinerU API Token',
    mineruApiTokenDesc: 'Stored in this plugin’s settings and used only for MinerU requests.',
    mineruApiTokenPlaceholder: 'Paste your MinerU API Token',
    mineruTaskTimeoutName: 'Task timeout (minutes)',
    mineruTaskTimeoutDesc: 'Stop waiting for a MinerU task after 5 to 120 minutes.',
    mineruUploadDisclosure: 'MinerU conversion uploads the PDF to MinerU’s official service. Converted Markdown and images are then saved in your Vault.',
    mineruDesktopOnlySettingDesc: 'MinerU conversion is available only in Obsidian desktop.',
