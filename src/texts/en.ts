export const EN_TEXTS = {
    ...
    pdfConversionBackendName: 'PDF conversion backend',
    pdfConversionBackendDesc: 'Choose the existing provider PDF conversion or the online MinerU API.',
    pdfConversionBackendNative: 'Provider PDF support',
    pdfConversionBackendMineru: 'MinerU online API',
    mineruApiTokenName: 'MinerU API token',
    mineruApiTokenDesc: 'Sent only to the official MinerU API when that backend is selected.',
