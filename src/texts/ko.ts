export const KO_TEXTS = {
    ...
    pdfConversionBackendName: 'PDF 변환 백엔드',
    pdfConversionBackendDesc: '기존 제공업체 변환 또는 온라인 MinerU API를 선택합니다.',
    pdfConversionBackendNative: '제공업체 PDF 지원',
    pdfConversionBackendMineru: 'MinerU 온라인 API',
    mineruApiTokenName: 'MinerU API 토큰',
    mineruApiTokenDesc: '이 백엔드를 선택한 경우에만 공식 MinerU API로 전송됩니다.',
