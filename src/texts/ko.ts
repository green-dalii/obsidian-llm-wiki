export const KO_TEXTS = {
    ...
    pdfBackendPreparing: 'PDF 변환을 준비하는 중…',
    mineruRequestingUpload: 'MinerU 업로드를 준비하는 중…',
    mineruUploading: 'PDF를 MinerU에 업로드하는 중…',
    mineruWaiting: 'MinerU를 기다리는 중…',
    mineruParsing: 'MinerU가 PDF를 분석하는 중…',
    mineruParsingPages: 'MinerU가 {total}페이지 중 {completed}페이지를 분석하는 중…',
    mineruConverting: 'MinerU 결과를 변환하는 중…',
    mineruDownloading: 'MinerU 결과를 다운로드하는 중…',
    mineruValidating: 'MinerU 결과를 확인하는 중…',
    mineruSaving: '변환된 Markdown과 이미지를 저장하는 중…',
    mineruMissingToken: '「{filename}」: 설정에 MinerU API Token을 추가한 뒤 다시 시도하세요.',
    ...
    mineruDownloadFailed: '「{filename}」: MinerU 결과를 다운로드하지 못했습니다. 연결을 확인한 뒤 다시 시도하세요.',
    mineruInvalidResult: '「{filename}」: MinerU가 안전하게 사용할 수 없는 결과를 반환했습니다. PDF를 다시 시도하세요.',
    mineruArtifactConflict: '「{filename}」: MinerU 출력 폴더에 이 플러그인이 만들지 않은 파일이 있습니다. 해당 폴더를 이동하거나 이름을 바꾼 뒤 다시 시도하세요.',
    ...
    pdfConversionBackendName: '변환 백엔드',
    pdfConversionBackendDesc: 'PDF 파일을 Markdown으로 변환할 방법을 선택합니다.',
    pdfConversionBackendNative: '네이티브 모델',
    pdfConversionBackendMineru: 'MinerU 공식 API',
    mineruApiTokenName: 'MinerU API Token',
    mineruApiTokenDesc: '이 플러그인의 설정에 저장되며 MinerU 요청에만 사용됩니다.',
    mineruApiTokenPlaceholder: 'MinerU API Token 붙여넣기',
    mineruTaskTimeoutName: '작업 시간 제한(분)',
    mineruTaskTimeoutDesc: '5~120분 후 MinerU 작업 대기를 중단합니다.',
    mineruUploadDisclosure: 'MinerU 변환은 PDF를 MinerU 공식 서비스에 업로드합니다. 변환된 Markdown과 이미지는 이후 Vault에 저장됩니다.',
    mineruDesktopOnlySettingDesc: 'MinerU 변환은 Obsidian 데스크톱에서만 사용할 수 있습니다.',
