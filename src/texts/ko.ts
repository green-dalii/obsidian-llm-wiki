export const KO_TEXTS = {
    ...
    pdfReadingInProgress: 'PDF를 읽는 중: {filename}',
    pdfExtractedTextHeading: '추출된 텍스트',
    sourceRejectedPdfUnsupported: '{filename}을(를) 건너뛰었습니다. 설정된 제공업체 또는 모델이 PDF 입력을 지원하지 않습니다.',
