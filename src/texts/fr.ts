export const FR_TEXTS = {
    ...
    pdfExtractedTextHeading: 'Texte extrait',
    sourceRejectedPdfUnsupported: '{filename} ignoré : le fournisseur ou modèle configuré ne prend pas en charge l’entrée PDF.',
