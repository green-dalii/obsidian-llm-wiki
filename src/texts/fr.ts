export const FR_TEXTS = {
    ...
    pdfBackendPreparing: 'Préparation de la conversion du PDF…',
    mineruRequestingUpload: 'Préparation de l’envoi vers MinerU…',
    mineruUploading: 'Envoi du PDF vers MinerU…',
    mineruWaiting: 'En attente de MinerU…',
    mineruParsing: 'MinerU analyse le PDF…',
    mineruParsingPages: 'MinerU analyse la page {completed} sur {total}…',
    mineruConverting: 'Conversion du résultat MinerU…',
    mineruDownloading: 'Téléchargement du résultat MinerU…',
    mineruValidating: 'Vérification du résultat MinerU…',
    mineruSaving: 'Enregistrement du Markdown converti et des images…',
    mineruMissingToken: '« {filename} » : Ajoutez votre Token API MinerU dans les paramètres, puis réessayez.',
    mineruDesktopOnly: '« {filename} » : La conversion PDF avec MinerU est disponible uniquement dans l’application de bureau.',
    mineruAuthenticationFailed: '« {filename} » : MinerU n’a pas pu vous authentifier. Vérifiez votre Token API, puis réessayez.',
    mineruQuotaExceeded: '« {filename} » : Votre quota MinerU est indisponible ou épuisé. Vérifiez votre compte MinerU, puis réessayez.',
    mineruRateLimited: '« {filename} » : La requête MinerU pour ce PDF est temporairement limitée. Réessayez plus tard.',
    mineruUploadFailed: '« {filename} » : MinerU n’a pas pu accepter l’envoi du PDF. Vérifiez le fichier et votre connexion, puis réessayez.',
    mineruTaskFailed: '« {filename} » : MinerU n’a pas pu traiter ce PDF. Vérifiez le PDF, puis réessayez.',
    mineruTaskTimedOut: '« {filename} » : MinerU n’a pas terminé avant le délai configuré. Augmentez le délai ou réessayez plus tard.',
    mineruDownloadFailed: '« {filename} » : Le résultat MinerU n’a pas pu être téléchargé. Vérifiez votre connexion, puis réessayez.',
    mineruInvalidResult: '« {filename} » : MinerU a renvoyé un résultat qui ne pouvait pas être utilisé en toute sécurité. Réessayez avec le PDF.',
    mineruArtifactConflict: '« {filename} » : Le dossier de sortie MinerU contient des fichiers non créés par ce plugin. Déplacez ou renommez ce dossier, puis réessayez.',
    mineruArtifactWriteFailed: '« {filename} » : Le résultat MinerU n’a pas pu être enregistré dans votre Vault. Vérifiez les autorisations et l’espace libre, puis réessayez.',
    mineruCancelled: '« {filename} » : La conversion PDF avec MinerU a été annulée.',
    ...
    sourceRejectedManagedArtifact: '« {filename} » se trouve dans un dossier de sortie géré par MinerU et ne peut pas être ingéré directement. Sélectionnez plutôt le PDF d’origine.',
    clearPdfCacheCommand: 'Vider le cache de conversion PDF',
    pdfCacheCleared: 'Cache PDF vidé ({count} entrées supprimées).',
    pdfConversionSection: 'Conversion PDF',
    pdfConversionBackendName: 'Backend de conversion',
    pdfConversionBackendDesc: 'Choisissez comment les fichiers PDF sont convertis en Markdown.',
    pdfConversionBackendNative: 'Modèle natif',
    pdfConversionBackendMineru: 'API officielle MinerU',
    mineruApiTokenName: 'Token API MinerU',
    mineruApiTokenDesc: 'Stocké dans les réglages du plugin et utilisé uniquement pour les requêtes MinerU.',
    mineruApiTokenPlaceholder: 'Collez votre Token API MinerU',
    mineruTaskTimeoutName: 'Délai de la tâche (minutes)',
    mineruTaskTimeoutDesc: 'Arrête d’attendre une tâche MinerU après 5 à 120 minutes.',
    mineruUploadDisclosure: 'La conversion MinerU envoie le PDF au service officiel MinerU. Le Markdown et les images convertis sont ensuite enregistrés dans votre Vault.',
    mineruDesktopOnlySettingDesc: 'La conversion MinerU est disponible uniquement dans Obsidian pour ordinateur.',
