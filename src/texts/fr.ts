export const FR_TEXTS = {
    ...
    pdfConversionBackendName: 'Backend de conversion PDF',
    pdfConversionBackendDesc: 'Choisissez la conversion du fournisseur ou l’API MinerU en ligne.',
    pdfConversionBackendNative: 'Prise en charge PDF du fournisseur',
    pdfConversionBackendMineru: 'API MinerU en ligne',
    mineruApiTokenName: 'Jeton API MinerU',
    mineruApiTokenDesc: 'Envoyé uniquement à l’API officielle MinerU avec ce backend.',
