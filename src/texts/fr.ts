export const FR_TEXTS = {
    ...
    historyButton: '📜 Historique d\'ingestion',
    historyModalTitle: 'Historique d\'ingestion',
    historyModalSubtitle: 'Opérations récentes depuis {path}',
