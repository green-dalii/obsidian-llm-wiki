export const ZH_HANT_TEXTS = {
    ...
    pdfConversionBackendName: 'PDF 轉換後端',
    pdfConversionBackendDesc: '選擇現有的 provider PDF 轉換或線上 MinerU API。',
    pdfConversionBackendNative: 'Provider PDF 支援',
    pdfConversionBackendMineru: 'MinerU 線上 API',
    mineruApiTokenName: 'MinerU API Token',
    mineruApiTokenDesc: '只有選擇此後端時才會傳送至 MinerU 官方 API。',
