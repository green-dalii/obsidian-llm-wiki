export const ZH_HANT_TEXTS = {
    ...
    pdfBackendPreparing: '正在準備 PDF 轉換…',
    mineruRequestingUpload: '正在準備上傳至 MinerU…',
    mineruUploading: '正在將 PDF 上傳至 MinerU…',
    mineruWaiting: '正在等待 MinerU…',
    mineruParsing: 'MinerU 正在解析 PDF…',
    mineruParsingPages: 'MinerU 正在解析第 {completed}/{total} 頁…',
    mineruConverting: '正在轉換 MinerU 結果…',
    mineruDownloading: '正在下載 MinerU 結果…',
    mineruValidating: '正在檢查 MinerU 結果…',
    mineruSaving: '正在儲存轉換後的 Markdown 與圖片…',
    mineruMissingToken: '「{filename}」：請在設定中加入 MinerU API Token，然後重試。',
    ...
    mineruDownloadFailed: '「{filename}」：無法下載 MinerU 結果。請檢查網路連線，然後重試。',
    mineruInvalidResult: '「{filename}」：MinerU 傳回的結果無法安全使用。請重新轉換此 PDF。',
    mineruArtifactConflict: '「{filename}」：MinerU 輸出資料夾中包含並非由本插件建立的檔案。請移動或重新命名該資料夾，然後重試。',
    ...
    pdfConversionBackendName: '轉換後端',
    pdfConversionBackendDesc: '選擇將 PDF 檔案轉換為 Markdown 的方式。',
    pdfConversionBackendNative: '原生模型',
    pdfConversionBackendMineru: 'MinerU 官方 API',
    mineruApiTokenName: 'MinerU API Token',
    mineruApiTokenDesc: '儲存在本插件的設定中，僅用於向 MinerU 發出請求。',
    mineruApiTokenPlaceholder: '貼上 MinerU API Token',
    mineruTaskTimeoutName: '任務逾時（分鐘）',
    mineruTaskTimeoutDesc: '等待 MinerU 任務 5 至 120 分鐘後停止。',
    mineruUploadDisclosure: '使用 MinerU 轉換時，PDF 會上傳至 MinerU 官方服務；轉換後的 Markdown 與圖片隨後儲存到你的 Vault。',
    mineruDesktopOnlySettingDesc: 'MinerU 轉換僅可在 Obsidian 桌面版中使用。',
