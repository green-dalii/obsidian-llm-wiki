export const ES_TEXTS = {
    ...
    pdfBackendPreparing: 'Preparando la conversión del PDF…',
    mineruRequestingUpload: 'Preparando la carga a MinerU…',
    mineruUploading: 'Subiendo el PDF a MinerU…',
    mineruWaiting: 'Esperando a MinerU…',
    mineruParsing: 'MinerU está analizando el PDF…',
    mineruParsingPages: 'MinerU está analizando la página {completed} de {total}…',
    mineruConverting: 'Convirtiendo el resultado de MinerU…',
    mineruDownloading: 'Descargando el resultado de MinerU…',
    mineruValidating: 'Comprobando el resultado de MinerU…',
    mineruSaving: 'Guardando el Markdown y las imágenes convertidos…',
    mineruMissingToken: '«{filename}»: Añade tu Token de API de MinerU en Ajustes y vuelve a intentarlo.',
    mineruDesktopOnly: '«{filename}»: La conversión de PDF con MinerU solo está disponible en la aplicación de escritorio.',
    mineruAuthenticationFailed: '«{filename}»: MinerU no pudo autenticarte. Comprueba tu Token de API y vuelve a intentarlo.',
    mineruQuotaExceeded: '«{filename}»: Tu cuota de MinerU no está disponible o se ha agotado. Comprueba tu cuenta de MinerU y vuelve a intentarlo.',
    mineruRateLimited: '«{filename}»: La solicitud de MinerU para este PDF está limitada temporalmente. Vuelve a intentarlo más tarde.',
    mineruUploadFailed: '«{filename}»: MinerU no pudo aceptar la carga del PDF. Comprueba el archivo y tu conexión y vuelve a intentarlo.',
    mineruTaskFailed: '«{filename}»: MinerU no pudo procesar este PDF. Comprueba el PDF y vuelve a intentarlo.',
    mineruTaskTimedOut: '«{filename}»: MinerU no terminó antes del tiempo límite configurado. Aumenta el tiempo límite o vuelve a intentarlo más tarde.',
    mineruDownloadFailed: '«{filename}»: No se pudo descargar el resultado de MinerU. Comprueba tu conexión y vuelve a intentarlo.',
    mineruInvalidResult: '«{filename}»: MinerU devolvió un resultado que no se pudo usar de forma segura. Vuelve a intentar el PDF.',
    mineruArtifactConflict: '«{filename}»: La carpeta de salida de MinerU contiene archivos no creados por este complemento. Mueve o cambia el nombre de esa carpeta y vuelve a intentarlo.',
    ...
    pdfConversionBackendName: 'Backend de conversión',
    pdfConversionBackendDesc: 'Elige cómo se convierten los archivos PDF a Markdown.',
    pdfConversionBackendNative: 'Modelo nativo',
    pdfConversionBackendMineru: 'API oficial de MinerU',
    mineruApiTokenName: 'Token de API de MinerU',
    mineruApiTokenDesc: 'Se guarda en la configuración del plugin y solo se usa para solicitudes a MinerU.',
    mineruApiTokenPlaceholder: 'Pega tu Token de API de MinerU',
    mineruTaskTimeoutName: 'Tiempo límite de tarea (minutos)',
    mineruTaskTimeoutDesc: 'Deja de esperar una tarea de MinerU después de 5 a 120 minutos.',
    mineruUploadDisclosure: 'La conversión con MinerU sube el PDF al servicio oficial de MinerU. Después, el Markdown y las imágenes convertidos se guardan en tu Vault.',
    mineruDesktopOnlySettingDesc: 'La conversión con MinerU solo está disponible en Obsidian para escritorio.',
