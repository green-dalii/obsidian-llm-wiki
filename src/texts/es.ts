export const ES_TEXTS = {
    ...
    pdfConversionBackendName: 'Backend de conversión PDF',
    pdfConversionBackendDesc: 'Elige la conversión del proveedor actual o la API online de MinerU.',
    pdfConversionBackendNative: 'Soporte PDF del proveedor',
    pdfConversionBackendMineru: 'API online de MinerU',
    mineruApiTokenName: 'Token de API de MinerU',
    mineruApiTokenDesc: 'Solo se envía a la API oficial de MinerU cuando se selecciona este backend.',
