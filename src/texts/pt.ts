export const PT_TEXTS = {
    ...
    pdfConversionBackendName: 'Backend de conversão PDF',
    pdfConversionBackendDesc: 'Escolha a conversão do provedor ou a API online do MinerU.',
    pdfConversionBackendNative: 'Suporte a PDF do provedor',
    pdfConversionBackendMineru: 'API online do MinerU',
    mineruApiTokenName: 'Token da API do MinerU',
    mineruApiTokenDesc: 'Enviado apenas para a API oficial do MinerU com este backend.',
