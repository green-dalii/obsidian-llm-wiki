export const PT_TEXTS = {
    ...
    pdfBackendPreparing: 'Preparando a conversão do PDF…',
    mineruRequestingUpload: 'Preparando o envio para o MinerU…',
    mineruUploading: 'Enviando o PDF para o MinerU…',
    mineruWaiting: 'Aguardando o MinerU…',
    mineruParsing: 'O MinerU está analisando o PDF…',
    mineruParsingPages: 'O MinerU está analisando a página {completed} de {total}…',
    mineruConverting: 'Convertendo o resultado do MinerU…',
    mineruDownloading: 'Baixando o resultado do MinerU…',
    mineruValidating: 'Verificando o resultado do MinerU…',
    mineruSaving: 'Salvando o Markdown convertido e as imagens…',
    mineruMissingToken: '«{filename}»: Adicione seu Token de API do MinerU nas configurações e tente novamente.',
    mineruDesktopOnly: '«{filename}»: A conversão de PDF com o MinerU está disponível apenas no aplicativo para desktop.',
    mineruAuthenticationFailed: '«{filename}»: O MinerU não conseguiu autenticar. Verifique seu Token de API e tente novamente.',
    mineruQuotaExceeded: '«{filename}»: Sua cota do MinerU está indisponível ou esgotada. Verifique sua conta do MinerU e tente novamente.',
    mineruRateLimited: '«{filename}»: A solicitação do MinerU para este PDF está temporariamente sujeita a limite de taxa. Tente novamente mais tarde.',
    mineruUploadFailed: '«{filename}»: O MinerU não conseguiu aceitar o envio do PDF. Verifique o arquivo e sua conexão e tente novamente.',
    mineruTaskFailed: '«{filename}»: O MinerU não conseguiu processar este PDF. Verifique o PDF e tente novamente.',
    mineruTaskTimedOut: '«{filename}»: O MinerU não terminou antes do limite configurado. Aumente o limite ou tente novamente mais tarde.',
    mineruDownloadFailed: '«{filename}»: Não foi possível baixar o resultado do MinerU. Verifique sua conexão e tente novamente.',
    mineruInvalidResult: '«{filename}»: O MinerU retornou um resultado que não pôde ser usado com segurança. Tente o PDF novamente.',
    mineruArtifactConflict: '«{filename}»: A pasta de saída do MinerU contém arquivos que não foram criados por este plugin. Mova ou renomeie essa pasta e tente novamente.',
    mineruArtifactWriteFailed: '«{filename}»: Não foi possível salvar o resultado do MinerU no seu Vault. Verifique as permissões e o espaço livre e tente novamente.',
    mineruCancelled: '«{filename}»: A conversão de PDF com o MinerU foi cancelada.',
    ...
    sourceRejectedManagedArtifact: '«{filename}» está dentro de uma pasta de saída gerenciada pelo MinerU e não pode ser ingerido diretamente. Selecione o PDF original.',
    clearPdfCacheCommand: 'Limpar cache de conversão PDF',
    pdfCacheCleared: 'Cache de PDF limpo ({count} entradas removidas).',
    pdfConversionSection: 'Conversão de PDF',
    pdfConversionBackendName: 'Backend de conversão',
    pdfConversionBackendDesc: 'Escolha como os arquivos PDF são convertidos em Markdown.',
    pdfConversionBackendNative: 'Modelo nativo',
    pdfConversionBackendMineru: 'API oficial do MinerU',
    mineruApiTokenName: 'Token de API do MinerU',
    mineruApiTokenDesc: 'Armazenado nas configurações do plugin e usado somente em solicitações ao MinerU.',
    mineruApiTokenPlaceholder: 'Cole seu Token de API do MinerU',
    mineruTaskTimeoutName: 'Tempo limite da tarefa (minutos)',
    mineruTaskTimeoutDesc: 'Interrompe a espera por uma tarefa do MinerU após 5 a 120 minutos.',
    mineruUploadDisclosure: 'A conversão com MinerU envia o PDF ao serviço oficial do MinerU. O Markdown e as imagens convertidos são salvos no Vault em seguida.',
    mineruDesktopOnlySettingDesc: 'A conversão com MinerU está disponível apenas no Obsidian para desktop.',
