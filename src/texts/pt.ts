export const PT_TEXTS = {
    ...
    historyButton: '📜 Histórico de ingestão',
    historyModalTitle: 'Histórico de ingestão',
    historyModalSubtitle: 'Operações recentes de {path}',
