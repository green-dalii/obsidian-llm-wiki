...
> **v1.25.1 PATCH (2026-07-20):** shipped — 11 commits, ~80 files, 2274 tests. Eight silent-loss bug fixes (#272/#287/#289/#292) + three big-file splits (wiki-engine/settings/main) + DiskCache<T> + build-verification lockfile fix. Phase A Obsidian bot 0.4.1 lint upgrade deferred to v1.26.x (Path C per `feedback_eslint_plugin_obsidianmd_0_4_skip`). Full composition: [CHANGELOG.md](./CHANGELOG.md).

> **v1.25.2 PATCH scope (locked 2026-07-20):** DocTpoint 6-issue triage (#305/#308/#310/#307/#312) + already-merged PR #304. **#168 granularity re-classified to v1.26.0 MINOR** (user-visible new feature, not a PATCH bug fix). Full scope + effort: [ROADMAP.md §Next Milestone](./ROADMAP.md#next-milestone-v1252-patch-target-5-6-working-days-single-patch).

> **Historical release notes** (v1.23.0+): see [CHANGELOG.md](./CHANGELOG.md). Keep a Changelog format is the canonical record; this file documents the project structure as it stands.
